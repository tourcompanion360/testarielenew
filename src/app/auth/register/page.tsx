        ...
        <div className="min-h-screen flex items-center justify-center p-4 py-12 relative">
            ...
            >
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-400">Inizia gratis, nessuna carta richiesta</p>
                </div>
                ...
                <div className="bg-[#1a1a2e] border border-[#2a2a4a] rounded-2xl p-8">
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        {password && (
                            <div className="space-y-2">
                                {passwordRequirements.map((req, i) => (
                                    <div
                                        key={i}
                                        className={`flex items-center gap-2 text-sm ${req.met ? 'text-green-400' : 'text-gray-500'
                                            }`}
                                    >
                        ...
                        <label className="flex items-start gap-2 text-gray-400 text-sm">
                            <input type="checkbox" className="rounded border-gray-600 mt-1" required />
                            <span>
                                Accetto i{' '}
